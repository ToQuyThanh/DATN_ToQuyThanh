...
def get_file_list(folder_path: str, p_postfix = ['.jpg'], sub_dir: bool = True) -> list:
    """
...
class MyDataSet(Data.Dataset):
    def __init__(self, txt, data_shape = (512, 512), channel=3, transform=None, target_transform=None):
        '''
...
class ImageData(Data.Dataset):
    def __init__(self, img_root, transform=None, t_transform=None):
        ...
        # Only get files in the 'images' subfolder of img_root
        ...
        self.label_path = [os.path.join(label_folder, os.path.splitext(os.path.basename(x))[0] + '.npy') for x in self.image_path]
        self.transform = transform
    ...
    #     # Resize cả image và label về 512x512
